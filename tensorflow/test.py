...
def main():
    ...
    print(target_model.layers[0].get_weights()[0])
    ...
    env.close()
    print(target_model.layers[0].get_weights()[0])
    target_model.save_weights("weights")
    with open('replay_memory', 'wb') as f:
        pickle.dump(replay_memory, f, pickle.HIGHEST_PROTOCOL)
